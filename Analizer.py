...
def main_ocupacion():
    ...
    f2 = getOccupationStats(r"C:\Users\Juampi\Documents\GitHub\DSI-TSSIM\INSTANCES\Resultados\F2\MM")
    ...
    f175 = getOccupationStats(r"C:\Users\Juampi\Documents\GitHub\DSI-TSSIM\INSTANCES\Resultados\F175\MM")
    ...
    plt.plot(f2, label="F2", color="C0")
    plt.plot(f3, label="f3", color="C1")
    plt.plot(f25, label="f4", color="C2")
    plt.plot(f175, label="f175", color="C3")
    plt.plot(f18, color="C4")

    plt.annotate(r"F2 ($\rho$={})".format(ro_f2), xy=(175, f2[-1]), xytext=(0, -8), textcoords='offset points', ha='right', va="top", color="C0")
    plt.annotate(r"F3 ($\rho$={})".format(ro_f3), xy=(175, f3[-1]), xytext=(0, -8), textcoords='offset points', ha='right', va="top", color="C1")
    plt.annotate(r"F25 ($\rho$={})".format(ro_f25), xy=(175, f25[-1]), xytext=(0, -8), textcoords='offset points', ha='right', va="top", color="C2")
    plt.annotate(r"F1.75 ($\rho$={})".format(ro_f175), xy=(175, f175[-1]), xytext=(0, 10), textcoords='offset points', ha='right', va="bottom", color="C3")
    plt.annotate(r"F18 ($\rho$={})".format(ro_f18), xy=(175, f18[-1]), xytext=(0, -6), textcoords='offset points', ha='right', va="top", color="C4")


def main_relocaciones():
    scenario_path = [(r"C:\Users\Juampi\Documents\GitHub\DSI-TSSIM\INSTANCES\Resultados\F2\MM", "F2 MM"),
                     (r"C:\Users\Juampi\Documents\GitHub\DSI-TSSIM\INSTANCES\Resultados\F2\MM-S", "F2 MM-S"),
                     (r"C:\Users\Juampi\Documents\GitHub\DSI-TSSIM\INSTANCES\Resultados\F2\RI", "F2 RI"),
                     (r"C:\Users\Juampi\Documents\GitHub\DSI-TSSIM\INSTANCES\Resultados\F2\RI-C", "F2 RI-C "),
                     (r"C:\Users\Juampi\Documents\GitHub\DSI-TSSIM\INSTANCES\Resultados\F2\RI-S", "F2 RI-S"),
                     (r"C:\Users\Juampi\Documents\GitHub\DSI-TSSIM\INSTANCES\Resultados\F2\RIL", "F2 RIL"),
                     (r"C:\Users\Juampi\Documents\GitHub\DSI-TSSIM\INSTANCES\Resultados\F2\RIL-C", "F2 RIL-C"),
                     (r"C:\Users\Juampi\Documents\GitHub\DSI-TSSIM\INSTANCES\Resultados\F2\RIL-S", "F2 RIL-S")
                    ]
    ...
    fig.suptitle(r'SCENARIO F2 25 Replicas ($\rho$= 0.77)')

    ax[0].set_title(r"TOTAL RELOCATIONS")
